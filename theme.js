...
const boxClassification = {
    ...
    //! text color doesn't get applied here
    legend: 'font-bold text-sm text-red-700',
...
const buttonClassification = {
  ...
  export default {
    global: {
        ...
        //! and here, as well as the background color
        help: 'text-xs text-red-500 bg-emerald-500',
